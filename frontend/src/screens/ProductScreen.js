...
const submitHandler = (e) => {
  ...
  useEffect(() => {
    //reload the page after submitting a review
    if(successReview) {
      setRating(0)
     setComment("")
     dispatch({type: productCreateReviewReset})
    }
    //getting the products from the backend server
  ...
  return (
    <div className="productScreen">
      <Link to="/" className="btn btn-light my-3 rounded productScreen__btn">
        <span>
      ...
      {loading ? (
        ...
        <>
          <Row>
            ...
            <Col md={3}>
              <ListGroup variant="flush">
                ...
                <ListGroup.Item className="productScreen__price">
                  Price: ${product.price}
                </ListGroup.Item>
                <ListGroup.Item>
                ...
                <ListGroup variant="flush">
                  ...
                  <ListGroup.Item>
                    <Button
                      ...
                      disabled={!product.countInStock && true}
                      className="btn-block"
                      type="button"
                    >
                      Add To Cart
          ...
          <Row className="mt-4">
            <Col md={6}>
              <h2>Reviews</h2>
              {product.reviews.length === 0 && <Message msg={"No Reviews"} />}
              <ListGroup>
                ...
                <ListGroup.Item>
                  ...
                  {errorReview && <Message variant="danger" msg={errorReview}/>}
                  {userInfo ? (
