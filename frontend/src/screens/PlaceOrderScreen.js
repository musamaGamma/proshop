...
const PlaceOrderScreen = ({history}) => {
  ...
  cart.taxPrice = addDecimal(+(0.15 * cart.itemsPrice).toFixed(2));

  cart.totalPrice = addDecimal(cart.itemsPrice + cart.shippingPrice + cart.taxPrice).toFixed(2);
        ...
        <Col md={8}>
          <ListGroup variant="flush" style={{ fontSize: "1.5rem" }}>
            ...
            <ListGroup.Item>
              ...
              <span className="ml-1">{cart.paymentMethod}</span>
            </ListGroup.Item>
            <ListGroup.Item>
              <h2>Order Items</h2>
